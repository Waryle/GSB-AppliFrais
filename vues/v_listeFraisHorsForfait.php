...
?>
             ...
             <tr>
              ...
              <?php  if($_SESSION['typeUtilisateur'] == 'Comptable'){?> 
...
<td><a href="index.php?uc=valider&action=repporterfrais&idFrais=<?php echo $id ?>&lstvisiteur=<?php echo $idvisiteur?>&mois=<?php echo $mois?>" 
        onclick="return confirm('Voulez-vous vraiment repporter ce frais?');">Repporter ce frais</a></td>
       <?php }elseif($_SESSION['typeUtilisateur'] == 'Visiteur'){
          $montanttotalfraisHF = $montanttotalfraisHF + $montant;
        ?>
